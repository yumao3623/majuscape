  ...
  return (
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <nav aria-label="Footer navigation"><Link href="/capitalization-rules-for-kids">Capitalization Rules</Link><Link href="/about">About</Link><Link href="/privacy">Privacy</Link><Link href="/sitemap.xml">Sitemap</Link></nav>
      </div>
